...
| [2026-07-26-context-engineering-rules-review](proposals/2026-07-26-context-engineering-rules-review.md) | 부분 채택(검토 중) | Anthropic "Claude 5 세대 컨텍스트 엔지니어링 규칙" 1차 출처 대조 — 원문 8축 중 6축 기수렴 실측(상시 32,637B : 지연 197,590B = 1:6.1). "80% 감축"은 제품 시스템 프롬프트 대상이라 범주 오적용으로 기각, AGENTS.md 스킬 분산은 §11·§12 Codex 가드레일 소실로 기각. 순수 중복 앵커 3개(1,039B=상시의 3.2%)와 미설치 도구명(SuperClaude·gstack) 정리만 채택 후보. rubric·비-markdown 스펙은 프로젝트 등록 시 재평가 |
