...
const roleLabel: Record<string, string> = { implementer: "구현 담당", reviewer: "검증 담당", architect: "설계 담당", explorer: "조사 담당", integrator: "통합 담당", troubleshooter: "원인 분석 담당" };
