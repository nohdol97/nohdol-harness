...
If the section is absent from REGISTRY.md, skip this step silently — it is install-site-specific (an install site with no deployment-site handoff should not be asked about one). Do not create the section here; `harness-install` owns it.
