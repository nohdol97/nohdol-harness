...
## 비목표
<이번에 의도적으로 하지 않는 것 — 범위 방어선. 반입 대상이면 "(배포처에서 후속 진행)"을 제목에 달고 사내 후속 항목을 여기에 열거한다>
