---
name: release
description: "Run post-merge releases: verify merge, draft runbook, confirm every mutation, deploy, verify, and close tracking; migrations include backup/rollback. Use for 배포, 릴리스, rollout, ship to production. Not for PR merge or pre-merge work; never auto-merge. Re-run: release, deploy, rollout, 배포, 릴리스, 롤백."
---
