...
**User comprehension is part of completion.** For feature/behavior work, delivery requires fresh correctness evidence (§13-2) **and** a report the user can read the change from: teach the decision forks (what versus what, and why this one) and hand over an ordered diff reading-guide. The goal is user growth, not opaque automation. **Nothing gates this, by decision** — the pre-PR comprehension quiz that did was removed 2026-08-04 (ADR 041), so what remains is report content: a thin report is a defect to raise, not a PR blocker. **Recorded as a decided absence, not an oversight** — a review finding that "§13 comprehension has no enforcement" is answered by this line, not reopened.
